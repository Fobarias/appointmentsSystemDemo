  ...
  <main class="h-full overflow-y-auto">
    <div class="container grid px-6 mx-auto">
        ...
        if($bissConn->getBusinessSetup($userid) != 1) {
          echo '
            ...
            <div class="flex items-center">                 
              <svg version="1.1" class="w-5 h-5 mr-2" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 123.996 123.996" style="enable-background:new 0 0 123.996 123.996;"
              ...
              <span>Your business isn\'t setup yet.</span>
            </div>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2">
        <div>
          <select id="selectCalendar" class="block w-full h-10 px-6 py-2 text-sm text-gray-900 border border-gray-300 rounded-lg employee bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
            <option disabled selected>Select employee</option>
            <?php $bissView->displayEmployeeSelect($businessData['id']); ?>
          </select>
